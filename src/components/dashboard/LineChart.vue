  ...
  <div class="col-span-6 sm:col-md-12">
    ...
    >
      <div class="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
        <div class="w-full">
          <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Line Chart</h3>
      ...
      <div class="max-w-full overflow-x-auto custom-scrollbar">
        <div id="chartThree" class="w-full">
          ...
          <VueApexCharts v-else type="area" height="310" :options="chartOptions" :series="series" />
        </div>
      </div>
    </div>
  </div>
...
watch(data, (value) => {
  series.value = value?.line_chart_data?.series || []
  chartOptions.value = {
    ...chartOptions.value,
    xaxis: {
