        ...
        <table class="min-w-full border">
          ...
          >
            <td class="px-5 py-4 sm:px-6">
              <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ value.name }}</p>
            </td>
            <td class="px-5 py-4 sm:px-6">
              <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ value.email }}</p>
            </td>
            <td class="px-5 py-4 sm:px-6">
              <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ value.verified_date !== null ? 'Verified' : 'Not Verified' }}</p>
            </td>
            <td class="px-5 py-4 sm:px-6">
              <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ value.verified_date }}</p>
            </td>
            <td class="px-5 py-4 sm:px-6">
              <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ value.user_roles?.join(', ') }}</p>
            </td>
            <td class="">
              <div class="flex justify-center items-center gap-1">
                <button class="">
                  <FontAwesomeIcon :icon="faPencil" class="text-amber-600" @click="openModal(value.id)" />
                </button>
              </div>
            </td>
          </tr>
...
const { pagination, users } = storeToRefs(userStore)
